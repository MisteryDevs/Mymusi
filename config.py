...
class Config:
    def __init__(self):
        self.API_ID = int(getenv("API_ID", "14050586"))
        ...
        self.SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/yourfreeapi")
        self.SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/rishusupport")
